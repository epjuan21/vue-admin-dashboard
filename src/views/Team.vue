  ...
  <div class="cards">
    <transition appear appear-active-class="animated flipInX">
      <a href="" class="card card-1" :class="{'light-card' : !isDarkMode, 'dark-card' : isDarkMode}">
        ...
        <h3>Slack</h3>
        <p :class="{'light-text': isDarkMode, 'dark-text': !isDarkMode}">Messaging app for all team comunitacion.</p>
      </a>
    </transition>
    <transition appear appear-active-class="animated flipInX">
    ...
    <transition appear appear-active-class="animated flipInX">
      <a href="" class="card card-4" :class="{'light-card' : !isDarkMode, 'dark-card' : isDarkMode}">
        ...
        <h3>Dropbox</h3>
        <p :class="{'light-text': isDarkMode, 'dark-text': !isDarkMode}">Sotorage space in the cloud.</p>
      </a>
    </transition>
    <transition appear appear-active-class="animated flipInX">
